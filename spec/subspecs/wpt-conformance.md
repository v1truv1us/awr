...
> **Current status (as of 2026-05-27):** 118 active curated WPT cases pass via
...
| CSSOM (starter subset, CLOSED 2026-05-27) | `css_inline_computed_style.js`, `css_external_stylesheet.js`, `css_style_declaration.js`, `css_style_block.js`, `css_cascade_basics.js`, `css_important.js`, `css_computed_properties.js`. Renderer integration for `display` / `visibility` / `white-space` covered by inline tests in `src/render.zig`. |
